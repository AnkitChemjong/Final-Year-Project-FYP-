    ...
    <main >
        <headContainer className="w-[100vw] h-[100vh] bg-white">
          <div className='flex flex-row justify-evenly items-center md:-mt-8'>
            ...
            <Button className="bg-green-600 text-white md:absolute bottom-10 px-10 py-5 animate-bounce hover:bg-blue-700 transition-all duration-3000 ease-in-out">Start</Button>
            </div>
            <div>
