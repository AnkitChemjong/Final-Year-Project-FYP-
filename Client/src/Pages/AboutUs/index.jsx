...
export default function AboutUs() {
    ...
    if (!allUser || !user) {
        return (
            <div className='flex flex-col gap-2 overflow-hidden min-h-screen bg-gray-50 dark:bg-gray-900'>
                <Navbar />
                <SkeletonCard />
                <Footer />
            </div>
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
            ...
            <main className="flex-1">
                ...
                <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
                    <div className="max-w-7xl mx-auto">
                        <div className='flex gap-2 items-center'>
                            <h1 className='text-3xl font-bold mb-2 font-heading dark:text-white'>What We Offer</h1>
                            <LottieAnimation animationData={category} width={150} height={150} speed={1} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {features.map((feature, index) => (
                                <Card key={index} className="hover:shadow-lg transition-shadow hover:scale-105 ease-in-out duration-100 cursor-pointer dark:bg-gray-700 dark:border-gray-600">
                                    <CardHeader>
                ...
                <section className="py-16 px-4 sm:px-6 lg:px-8 dark:bg-gray-900">
                    <div className="max-w-7xl mx-auto">
                        <div className='flex gap-2 items-center'>
                            <h1 className='text-3xl font-bold mb-2 font-heading dark:text-white'>Meet Our Founder</h1>
                            <LottieAnimation animationData={admin} width={150} height={150} speed={1} />
                        </div>
                        <div className="flex flex-col md:flex-row items-center gap-8 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                            ...
                            <div className="flex-1 space-y-4">
                                <div>
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{adminsData?.userName || "Admin"}</h3>
                ...
                <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
                    <div className="max-w-7xl mx-auto">
                        <div className='flex items-center gap-2 '>
                            <h2 className="text-2xl font-bold mb-2 font-heading dark:text-white">Our Expert Instructors</h2>
                            <LottieAnimation animationData={teacher} width={150} height={150} speed={1} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {teachers.map((teacher, index) => (
                                <Card onClick={() => navigate(`/teacher/details/${teacher?._id}`)} key={index} className="text-center p-6 cursor-pointer hover:scale-105 transition-all ease-in-out duration-100 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <CardTitle className="dark:text-white">{teacher.userName}</CardTitle>
                                    <CardDescription className="mt-2">
                                        <p className="font-medium text-gray-900 dark:text-gray-300">{teacher?.category || "N/A"}</p>
                                        <p className="text-gray-600 dark:text-gray-400">
                ...
                <section className="py-16 px-4 sm:px-6 lg:px-8 dark:bg-gray-900">
                    <div className="max-w-7xl mx-auto">
                        <div className='flex gap-2 items-center'>
                            <h1 className='text-3xl font-bold mb-2 font-heading dark:text-white'>Student Saying</h1>
                        ...
                        {topRating && topRating?.length > 0 ? (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {topRating.map((feedback, index) => (
                                    <Card key={index} className="hover:shadow-lg transition-shadow duration-300 h-full flex flex-col dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div className="p-6 flex-1 flex flex-col">
                                            <div className="flex items-start gap-4 mb-4">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-gray-900 dark:text-white">{feedback?.userId?.userName}</p>
                                                    <div className="flex items-center mt-1">
                                                        ...
                                                        <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">{feedback?.rating}.0</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                                                <p className="font-medium text-gray-900 dark:text-white">{feedback?.courseId?.title}</p>
                                            </div>
                                        </div>
                                    </Card>
                                ))}
