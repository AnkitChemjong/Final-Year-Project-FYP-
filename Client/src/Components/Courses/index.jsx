      ...
      <div className="flex flex-col w-full p-6 min-h-screen">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className='flex gap-1 items-center'>
            <h1 className="text-3xl font-bold  font-heading">All Courses</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className={`${user?.theme & "bg-white"} ${user?.theme===false && "bg-black text-white"} p-6 rounded-lg shadow-sm border border-gray-200`}>
            <div className="flex items-center justify-between">
              <div>
                <h3 className=" text-sm font-medium font-heading">Admin-Created Courses</h3>
                <p className="text-3xl font-bold  mt-2">{adminCreatedCourses}</p>
              </div>
          ...
          <div className={`${user?.theme & "bg-white"} ${user?.theme===false && "bg-black text-white"} p-6 rounded-lg shadow-sm border border-gray-200`}>
            <div className="flex items-center justify-between">
              <div>
                <h3 className=" text-sm font-medium font-heading">Teacher-Created Courses</h3>
                <p className="text-3xl font-bold  mt-2">{teacherCreatedCourses}</p>
              </div>
